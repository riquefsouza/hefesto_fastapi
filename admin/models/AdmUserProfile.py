...
class AdmUserProfile(Base):
    ...
    idProfile = Column('usp_prf_seq', BigInteger, nullable=False, ForeignKey('adm_profile.prf_seq'))
    idUser = Column('usp_use_seq', BigInteger, nullable=False, ForeignKey('adm_user.usu_seq'))
