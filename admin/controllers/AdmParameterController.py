...
def save(form: AdmParameterForm, response: Response, db: Session = Depends(get_db)):
...
def update(id: int, form: AdmParameterForm, response: Response, db: Session = Depends(get_db)):
